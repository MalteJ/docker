...
func InitDriver(job *engine.Job) engine.Status {
	...
	if err != nil {
		...
		if err := createBridge(bridgeIP, mac, bridgeIPv6Network, enableIPv6); err != nil {
			return job.Error(err)
		}
...
func createBridge(bridgeIP string, mac string, bridgeIPv6 string, enableIPv6 bool) error {
	nameservers := []string{}
